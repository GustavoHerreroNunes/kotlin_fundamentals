...
import br.com.fiap.aplicacaovazia.databinding.ActivityConsultUserBinding

class ConsultUserActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ACTIVITY_TAG = getString(R.string.title_activity_consult_user)
